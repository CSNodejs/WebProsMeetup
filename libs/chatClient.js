(function($){
    ...
    var ListView = Backbone.View.extend({
        ...
        addUserList: function(data){
            ...
            $('#userlist').append('<li class="user">' + item.get('nick') + '</li>');
            this.collection.add(item);
        },
        ...
        appendItem: function(item){
            $('ul', this.el).append('<li><span class="username">' + item.get('nicktext') + '</span>: <span class="message">' + item.get('chattext') + '</span></li>');
        }
    });
